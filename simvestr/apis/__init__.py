...
from .deleteaccount import api as ns14
from .refreshtoken import api as ns15
...
api.add_namespace(ns14, path="/deleteaccount")
api.add_namespace(ns15, path="/refreshtoken")
